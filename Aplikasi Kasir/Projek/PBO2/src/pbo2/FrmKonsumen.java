...
int pil;
    ...
    private void tampilIcon(){
        ...
        ImageIcon("./gambar/Edit_16x16.png"));
        BtnHapus.setIcon(new
        ImageIcon("./gambar/Delete_16x16.png"));
        BtnSimpan.setIcon(new
        ImageIcon("./gambar/Save_16x16.png"));
        BtnBatal.setIcon(new
        ImageIcon("./gambar/Cancel_16x16.png"));
        BtnKeluar.setIcon(new 
        ImageIcon("./gambar/Log_out16x16.png"));
}
...
JOptionPane.showMessageDialog(null, e.getMessage());
    ...
    private void initComponents() {
        ...
        BtnTambah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pbo2/gambar/Add_16x16.png"))); // NOI18N
        ...
        BtnKoreksi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pbo2/gambar/Check_16x16.png"))); // NOI18N
        ...
        BtnHapus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pbo2/gambar/Remove_16x16.png"))); // NOI18N
